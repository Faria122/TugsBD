...
export const HeroSection = () => {
  return (
    <div className='py-16 md:py-24 lg:py-32 relative z-0 overflow-x-clip'>
      ...
      <div className="container">
        <div className='flex flex-col items-center'>
          ...
          <div className='bg-gray-950 border-gray-800 px-4 py-1.5 inline-flex items-center gap-4 rounded-lg'>
            ...
            <div> Available for Riggers, Millwrights, Erectors.</div>
          </div>
        </div>
        <div className='max-w-lg mx-auto'>
          ...
          <p className='mt-4 text-center text-white/60 md:text-lg'>To be recognised as a leading general contracting company of
            ...
            their expectations through exceptional performance.
          </p>
        </div>
